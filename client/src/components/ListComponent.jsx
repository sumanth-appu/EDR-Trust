  ...
  return (
    ...
    >
            ...
            {add || <div className="flex items-center gap-2">
                ...
                <Link className="text-sm sm:text-base px-1 sm:px-2 py-1 rounded-lg btn text-white hover:cursor-pointer transform transition-transform duration-300 hover:scale-[1.02]" to={to}>
                  courses 
                </Link>
            </div>}
    </div>
